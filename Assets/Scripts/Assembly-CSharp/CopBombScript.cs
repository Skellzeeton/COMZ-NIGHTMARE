...
public class CopBombScript : MonoBehaviour
{
	...
	public float explodeTime = 12.5f;
	...
	private void Update()
	{
		...
		GameObject gameObject = Object.Instantiate(resourceConfig.rocketExlposion, base.transform.position, Quaternion.identity) as GameObject;
